...
SELECT COUNTRY, COUNT(*) AS "NUMBER OF WINNERS" FROM NOBEL_WIN GROUP BY COUNTRY;
SELECT COUNTRY, COUNT(*) AS "NUMBER OF WINNERS" FROM NOBEL_WIN GROUP BY COUNTRY HAVING COUNT(*) > 1;
SELECT SUBJECT, COUNT(*) AS "NUMBER OF WINNERS" FROM NOBEL_WIN GROUP BY SUBJECT;